...
//行政职务
public class DocumentAdministrativePostVO extends UnDeleteModel implements Serializable{
	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -1836836870936500414L;
    ...
    private String department;//工作科室/部门

    private String positionLevel;//职务层次
    @Transient
    private String positionLevelName;//职务层次
    
    private String firstServingTime;//现职务层次首次任职时间
    
    private String servingTerm;//任现同等职务年限
    ...
    private String dateBegin;//职务开始时间

    private String dateEnd;//职务结束时间
	...
	public String getFirstServingTime() {
		return firstServingTime;
	}

	public void setFirstServingTime(String firstServingTime) {
		this.firstServingTime = firstServingTime;
	}

	public String getServingTerm() {
		return servingTerm;
	}

	public void setServingTerm(String servingTerm) {
		this.servingTerm = servingTerm;
	}
