...
public class OrgPersonnelScienceEducation extends PersonnelContextModel{
    
    public final static String COLUMN_FIELD_EDUCATION_TYPE = "scienceEducationType"; 
	...
	private Integer paperRelationTopic;
	...
	public Integer getPaperRelationTopic() {
		return paperRelationTopic;
	}

	public void setPaperRelationTopic(Integer paperRelationTopic) {
