...
public class OrgAgencyDetail extends BaseModel {
	...
	private Date agencyFoundingTime;
    ...
    private Date agencysCreateTime;
	...
	public Date getAgencyFoundingTime() {
		return agencyFoundingTime;
	}

	public void setAgencyFoundingTime(Date agencyFoundingTime) {
    ...
    public Date getAgencysCreateTime()
    {
        return agencysCreateTime;
    }

    public void setAgencysCreateTime(Date agencysCreateTime)
    {
