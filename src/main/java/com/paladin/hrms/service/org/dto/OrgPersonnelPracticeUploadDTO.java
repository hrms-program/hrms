...
public class OrgPersonnelPracticeUploadDTO {
	...
	// 医师执业类别代码
	@ReadProperty(cellIndex = 1, enumType = "practice-category-type")
	private Integer practiceCategory;
	// 医师执业范围代码
	@ReadProperty(cellIndex = 2,multiple=true,enumType = "practice-scope")
	private String practiceScope;
	// 是否注册为多地点执业医师
	@ReadProperty(cellIndex = 3, enumType = "boolean")
	private Integer isMultisite;
	// 第2执业单位类别代码
	@ReadProperty(cellIndex = 4, enumType = "practice-category")
	private Integer secondCategory;
	// 第3执业单位类别代码
	@ReadProperty(cellIndex = 5, enumType = "practice-category")
	...
	@ReadProperty(cellIndex = 9, enumType = "boolean")
	private Integer isDispatched;
	// 上年总收入
	@ReadProperty(cellIndex = 10)
	private String totalIncome;
	// 是否有养老保障
	@ReadProperty(cellIndex = 11, enumType = "boolean")
	...
	// 护考免考
	@ReadProperty(cellIndex = 19, enumType = "boolean")
