...
var baseModelColumns = [{ name: "id", inputType: "ID" }, { name: "identificationType", inputType: "SELECT", enum: "identification-type" }, { name: "identificationNo", inputType: "TEXT" }, { name: "name", inputType: "TEXT" }, { name: "usedName", inputType: "TEXT" }, { name: "sex", inputType: "SELECT", enum: "sex" }, { name: "cellphone", inputType: "TEXT" }, { name: "officePhone", inputType: "TEXT" }, { name: "profilePhoto", inputType: "TEXT" }, { name: "agencyId", inputType: "TEXT" }, { name: "agencyName", inputType: "TEXT" }, { name: "nationality", inputType: "SELECT", enum: "nationality" }, { name: "nation", inputType: "SELECT", enum: "nation" }, { name: "birthday", inputType: "DATE" }, { name: "startWorkTime", inputType: "DATE" }, { name: "joinPartyTime", inputType: "DATE" }, { name: "politicalAffiliation", inputType: "SELECT", enum: "political-affiliation" }, { name: "interest", inputType: "TEXT" }, { name: "nativePlace", inputType: "TEXT" }, { name: "status", inputType: "SELECT", enum: "peronnel-status" }, { name: "profilePhotoFile"}];
...
var practiceModelColumns = [{ name: "id", inputType: "ID" }, { name: "personnelType", inputType: "SELECT", enum: "personnel-type", colspan: 2 }, { name: "docQualificationCode", inputType: "TEXT", dependency: ["personnelType", "1"] }, { name: "docCertCode", inputType: "TEXT", dependency: ["personnelType", "1"] }, { name: "isCountryCert", inputType: "SELECT", enum: "boolean", dependency: ["personnelType", "1"], colspan: 2 }, { name: "inpatientCertCode", inputType: "TEXT", dependency: ["isCountryCert", "1"], colspan: 2 }, { name: "isGeneralPractitioner", inputType: "SELECT", enum: "boolean", dependency: ["personnelType", "1"], colspan: 2 }, { name: "practiceAddress", inputType: "TEXT", dependency: ["personnelType", "1"], colspan: 2 }, { name: "registrationDate", inputType: "DATE", dependency: ["personnelType", "1"] }, { name: "practiceCategory", inputType: "SELECT", dependency: ["personnelType", "1"], enum: "practice-category-type" }, { name: "practiceScope", inputType: "SELECT", enum: "practice-scope", dependency: ["personnelType", "1"], colspan: 2 }, { name: "isDispatched", inputType: "SELECT", enum: "boolean", dependency: ["personnelType", "1"], colspan: 2 }, { name: "isMultisite", inputType: "SELECT", enum: "boolean", dependency: ["personnelType", "1"], colspan: 2 }, { name: "secondCategory", inputType: "SELECT", enum: "practice-category", dependency: ["isMultisite", "1"] }, { name: "thirdCategory", inputType: "SELECT", enum: "practice-category", dependency: ["isMultisite", "1"] }, { name: "expertise", inputType: "TEXT", dependency: ["personnelType", "1"] }, { name: "docTrainCert", inputType: "SELECT",enum:"doc-train-cert", dependency: ["personnelType", "1"], colspan: 2 }, { name: "nurseCertCode", inputType: "TEXT", dependency: ["personnelType", "2"], colspan: 2 }, { name: "nurseInstitution", inputType: "TEXT", dependency: ["personnelType", "2"] }, { name: "lastRegistrationDate", inputType: "DATE", dependency: ["personnelType", "2"] }, { name: "isExam", inputType: "SELECT", enum: "boolean", dependency: ["personnelType", "2"], colspan: 2 }, { name: "nurseExamTime", inputType: "DATE", dependency: ["isExam", "0"], colspan: 2 }, { name: "startWorkDate", inputType: "DATE", dependency: ["personnelType", "2"] }, { name: "nurseCategory", inputType: "TEXT", dependency: ["personnelType", "2"] }, { name: "certName", inputType: "TEXT", dependency: ["personnelType", "4", "5", "6", "7", "8"] }, { name: "issueUnit", inputType: "TEXT", dependency: ["personnelType", "4", "5", "6", "7", "8"] }, { name: "issueDate", inputType: "DATE", dependency: ["personnelType", "4", "5", "6", "7", "8"] }, { name: "startDate", inputType: "DATE", dependency: ["personnelType", "4", "5", "6", "7", "8"] }, { name: "endDate", inputType: "DATE", dependency: ["personnelType", "4", "5", "6", "7", "8"], colspan: 2 }, { name: "isInVillageClinic", inputType: "SELECT", enum: "boolean" }, { name: "vdocCertCode", inputType: "TEXT", dependency: ["isInVillageClinic", "1"] }, { name: "registVillageAgency", inputType: "TEXT", dependency: ["isInVillageClinic", "1"] }, { name: "registDate", inputType: "DATE", dependency: ["isInVillageClinic", "1"] }, { name: "totalIncome", inputType: "TEXT", dependency: ["isInVillageClinic", "1"] }, { name: "isMedicalInsurance", inputType: "SELECT", enum: "boolean", dependency: ["isInVillageClinic", "1"] }, { name: "isInjuryInsurance", inputType: "SELECT", enum: "boolean", dependency: ["isInVillageClinic", "1"] }, { name: "isEndowmentInsurance", inputType: "SELECT", enum: "boolean", dependency: ["isInVillageClinic", "1"] }, { name: "workYears", inputType: "TEXT", dependency: ["isInVillageClinic", "1"] }, { name: "isOnjobTrain", inputType: "SELECT", enum: "boolean", dependency: ["isInVillageClinic", "1"] }];
...
var workExperienceModelColumns = [{ name: "id", inputType: "ID" }, { name: "personnelId", inputType: "ID" }, { name: "workUnit", inputType: "TEXT", title: "工作单位" }, { name: "workPlace", inputType: "TEXT", title: "工作地点" }, { name: "workStartTime", inputType: "DATE", title: "工作开始时间" }, { name: "workEndTime", inputType: "DATE", title: "工作结束时间" }, { name: "workDept", inputType: "SELECT", enum: "dept-type", title: "工作科室" }, { name: "jobSituation", inputType: "SELECT", enum: "duty", title: "任职情况" }, { name: "workPost", inputType: "SELECT", enum: "work-post-type", title: "工作岗位" }, { name: "majorTechnologyWork", inputType: "SELECT", enum: "major", title: "从事专业技术工作" }, { name: "status", inputType: "SELECT", enum: "personal-info-status", title: "审核状态" }, { name: "attachments", inputType: "ATTACHMENT", fileName: "attachmentFiles", title: "附件" }];
...
var registrationsModelColumns = [{ name: "id", inputType: "ID" }, { name: "personnelId", inputType: "ID" }, { name: "certificateCode", inputType: "TEXT", title: "执业证书编码" }, { name: "placeName", inputType: "TEXT", title: "执业地点名称" }, { name: "category", inputType: "TEXT", title: "执业类别" }, { name: "issuingOrgan", inputType: "TEXT", title: "发证机关" }, { name: "businessType", inputType: "TEXT", title: "业务类型" },{ name: "dateOfIssue", inputType: "DATE", title: "发证日期" }, { name: "technicalTitle", inputType: "TEXT", title: "技术职称" }, { name: "currentBusinessApprovalDate", inputType: "DATE", title: "当前业务批准日期" },{ name: "currentBusinessApprovalOrgans", inputType: "TEXT", title: "当前业务审批机关" },{ name: "workingDepartment", inputType: "TEXT", title: "工作科室" },{ name: "qualificationCertificateCode", inputType: "TEXT", title: "执业资格证书编号" }, { name: "practiceRange", inputType: "TEXT", title: "执业范围" }, { name: "level", inputType: "TEXT", title: "执业级别" }, { name: "firstRegisterTime", inputType: "DATE", title: "首次注册时间" }, { name: "practiceAddress", inputType: "TEXT", title: "执业地点地址" }, { name: "registerIdCard", inputType: "TEXT", title: "执业注册身份证" }, { name: "address", inputType: "TEXT", title: "地址" }, { name: "districtCode", inputType: "TEXT", title: "行政区划代码" }, { name: "districtName", inputType: "TEXT", title: "行政区划名称" }, { name: "creationTime", inputType: "DATE", title: "创建时间" }, { name: "lastUpdateTime", inputType: "DATE", title: "最后更新时间" }];
